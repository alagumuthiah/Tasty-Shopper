...
function RecipeDetails() {
    ...
    let instructions = selectedRecipe.instructions.split("."); //issues in few recipes as there is a "." afterthe number of steps. so that is considered as a new instruction(number render as one instruction and the actual instruction as separate instruction )
    ...
    return (
        ...
        <div>
            ...
            <Link to={`/update/recipe/${dummyRecipeId}`} state={{ updateRecipe: updateRecipes }} style={{ textDecoration: 'none' }}>
